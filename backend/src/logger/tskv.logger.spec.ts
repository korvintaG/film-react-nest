...
describe('TskvLogger', () => {
    ...
    it('logger.log() should print correct tskv',()=> {
        ...
        logger.log(logText);
        expect(logSpy).toHaveBeenCalledWith(`level=log\tmessage=${logText}\toptionalParams=\n`);
    });
    ...
    it('logger.warn() should print correct tskv',()=> {
        ...
        expect(warnSpy).toHaveBeenCalledWith(`level=warn\tmessage=${warnText}\toptionalParams=\n`);
    });
    ...
    it('logger.error() should print correct tskv',()=> {
        ...
        expect(errorSpy).toHaveBeenCalledWith(`level=error\tmessage=${errorText}\toptionalParams=\n`);
    });
